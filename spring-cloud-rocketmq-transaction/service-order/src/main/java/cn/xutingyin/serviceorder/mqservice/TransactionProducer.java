package cn.xutingyin.serviceorder.mqservice;
...
import cn.xutingyin.serviceorder.config.Jms;
import cn.xutingyin.serviceorder.service.ProduceOrderService;
...
class TransactionListenerImpl implements TransactionListener {
    ...
    public LocalTransactionState executeLocalTransaction(Message msg, Object arg) {
        ...
        // 模拟执行本地事务begin=======
        /**
         * 本地事务执行会有三种可能 1、commit 成功 2、Rollback 失败 3、网络等原因服务宕机收不到返回结果
         */
    ...
    public LocalTransactionState checkLocalTransaction(MessageExt msg) {
        ...
        /**
         * 因为有种情况就是：上面本地事务执行成功了，但是return LocalTransactionState.COMMIT_MESSAG的时候 服务挂了，那么最终 Brock还未收到消息的二次确定，还是个半消息
         * ，所以当重新启动的时候还是回调这个回调接口。 如果不先查询上面本地事务的执行情况 直接在执行本地事务，那么就相当于成功执行了两次本地事务了。
         */
